...
public class AddEmployee extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddEmployee(){
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/p8.jpg"));
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    String nic = textField_5.getText();
            ...
            c =DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\HAIDER\\Documents\\HMS.accdb"); 
                        ...
                        String str = "insert into employee(name,age,gender,job,salary,phone,nic,email)" + "values( '"+name+"', '"+age+"', '"+gender+"','"+s6+"', '"+salary+"', '"+phone+"','"+nic+"', '"+email+"')";
