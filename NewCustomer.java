...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/p5.jpg"));
		...
		contentPane.add(lblId);
                ...
                comboBox = new JComboBox(new String[] {"Passport", "NIC#", "Voter Id", "Driving license"});
        ...
        c =DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\HAIDER\\Documents\\HMS.accdb");		
	    			...
	    			String s7 =  t5.getText();
                                ...
                                String q1 = "insert into customer(id, number, name, gender, country, roomnumber, status, deposite)" + "values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"')";
                                String q2 = "update room set availability = 'Occupied' where roomnumber = "+s6;
                                s=c.prepareStatement(q1);
                                s.executeUpdate();
                                s=c.prepareStatement(q2);
                                s.executeUpdate();
