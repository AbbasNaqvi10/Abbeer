...
public class AddRoom extends JFrame implements ActionListener{
	...
	contentPane.setLayout(null);
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/p9.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            c =DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\HAIDER\\Documents\\HMS.accdb"); 
                ...
                String str = "insert into room (roomnumber,availability,cleanstatus,price,bedtype)" + "values( '"+room+"', '"+available+"', '"+status+"','"+price+"', '"+type+"')";
